...
export function App() {
    ...
    return (
        <div className="w-screen h-screen flex flex-col">
            <div className="container mx-auto flex items-center justify-between flex-none lg:p-4 md:p-2 p-2">
            ...
            <ScrollArea className="flex-1 h-0 w-full">
                <div className="container min-w-md mx-auto flex flex-col lg:p-6 md:p-4 p-2 lg:gap-8 md:gap-4 gap-2 max-w-2xl lg:max-w-3xl xl:max-w-5xl">
                    <div className="flex flex-col lg:flex-row items-start lg:gap-8 md:gap-4 gap-2">
                        <ConfigurationCard />
                        <PreviewCard />
                    </div>
                </div>
